...
import pdc.assignment.erp.api.order.OrderAdd;
import pdc.assignment.erp.dbo.entity.OrderDetailsEntity;
import pdc.assignment.erp.model.table.OrderDetailsTableModel;
import pdc.assignment.erp.model.table.generator.OrderDetailsTableGenerator;
...
public class Invoice extends javax.swing.JDialog implements InvoiceFrame {
    ...
    private List<OrderDetailsEntity> data = new ArrayList<>();
    public Invoice() {
        initComponents();
    ...
    public Invoice(javax.swing.JFrame prev) {
        this.prev = prev;
    ...
    public void refreshTable() {
        OrderDetailsTableModel results = OrderDetailsTableGenerator.get(data);
        ...
        for(OrderDetailsEntity orderDetailsEntity : data){
            number = number.add(orderDetailsEntity.getNumber());
            price = price.add(orderDetailsEntity.getPrice().multiply(orderDetailsEntity.getNumber()));
        }

        if(price.compareTo(BigDecimal.valueOf(1e+17)) > 0) {
            jLabel8.setText("The total price is too expensive!");
        }
        else {
            jLabel8.setText("Total number: " + number.toString() + ", Total price: " + price.toString());
        }
    }
    /**
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new OrderDetailManagement(this).setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        new OrderDetailManagement(this, row, data.get(row)).setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(data.isEmpty()){
            jLabel7.setText("Please add an item.");
            return;
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            new OrderDetailManagement(this, jTable1.getSelectedRow(), data.get(jTable1.getSelectedRow())).setVisible(true);
        }
    ...
    public void add(){
        ...
        if(!OrderAdd.orderAdd(customer, user, Timestamp.valueOf(LocalDateTime.now()), data, remark)){
    ...
    public void updateOrderDetail(int row, OrderDetailsEntity e) {
        data.remove(row);
        data.add(e);
        refreshTable();
    }
    ...
    public void addOrderDetail(OrderDetailsEntity e) {
        data.add(e);
        refreshTable();
    }
    /**

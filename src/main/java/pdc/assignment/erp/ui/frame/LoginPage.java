...
import pdc.assignment.erp.api.user.UserLogin;
...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void login() {
        ...
        if (username.isEmpty()) {
            jLabel4.setText("Login failed, username cannot empty.");
            return;
        }

        if (password.isEmpty()) {
            jLabel4.setText("Login failed, password cannot empty.");
            return;
        }

        if (UserLogin.userLogin(username, password)) {
            this.dispose();
        } else {
            jLabel4.setText("Login failed, incorrect username or password.");
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Note: both of the default username and password are admin.");
